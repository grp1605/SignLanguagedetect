...
while True:
    ...
    count = {
             ...
             'S': len(os.listdir(directory+"/Stop")),
             'E': len(os.listdir(directory+"/Help")),
             'P': len(os.listdir(directory+"/Please")),
             'T': len(os.listdir(directory+"/Thankyou")),  
             'I': len(os.listdir(directory+"/I love you")), 
             'L': len(os.listdir(directory+"/Play")),
             'W': len(os.listdir(directory+"/What")),
             'N': len(os.listdir(directory+"/Name")),
             'F': len(os.listdir(directory+"/Food")),
             }
    ...
    if interrupt & 0xFF == ord('S'):
        cv2.imwrite(directory+'Stop/'+str(count['S'])+'.png',frame)
    if interrupt & 0xFF == ord('E'):
        cv2.imwrite(directory+'Help/'+str(count['E'])+'.png',frame)
    if interrupt & 0xFF == ord('P'):
        cv2.imwrite(directory+'Please/'+str(count['P'])+'.png',frame)
    if interrupt & 0xFF == ord('T'):
        cv2.imwrite(directory+'Thankyou/'+str(count['T'])+'.png',frame)
    if interrupt & 0xFF == ord('I'):
        cv2.imwrite(directory+'I love you/'+str(count['I'])+'.png',frame)
    if interrupt & 0xFF == ord('L'):
        cv2.imwrite(directory+'Play/'+str(count['L'])+'.png',frame)
    if interrupt & 0xFF == ord('W'):
        cv2.imwrite(directory+'What/'+str(count['W'])+'.png',frame)
    if interrupt & 0xFF == ord('N'):
        cv2.imwrite(directory+'Name/'+str(count['N'])+'.png',frame)
    if interrupt & 0xFF == ord('F'):
        cv2.imwrite(directory+'Food/'+str(count['F'])+'.png',frame)
